...
import { runCommandPalette } from "./ui-palette.js";
...
Opens an experimental command-first interface for the current workspace.
Type start, stop, status, or devices; Tab completes commands.`,
