...
This package contains the `glossa` executable. Node 24 is required. Install the open beta from npm and choose a recognizable name during this computer's first enrollment:
